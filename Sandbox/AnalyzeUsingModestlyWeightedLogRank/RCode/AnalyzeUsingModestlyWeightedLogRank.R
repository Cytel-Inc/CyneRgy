...
#'                      }
AnalyzeUsingModestlyWeightedLogRank <- function(SimData, DesignParam, LookInfo = NULL, UserParam = NULL )
{
    nError <- 0 
    ...
    {
        fitWeightedLogRankInterim <<- fitWeightedLogRank
        
        if (fitWeightedLogRankInterim$v_u / gDesign$var_u[2] > 0.975){
            
            c_1 <- qnorm(gDesign$alpha_one_sided)
        ...
        {
            c_1 <- crit_1_of_2(info_frac_sf = fitWeightedLogRankInterim$v_u / gDesign$var_u[2],
                               alpha_spend_f = gDesign$alpha_spend_f,
                               alpha_one_sided = gDesign$alpha_one_sided)
        }
        
        c_1 <<- c_1
        nDecision <- ifelse(  fitWeightedLogRank$z  <=c_1, 2, 0 ) 
    ...
    else
    {
        ...
        c_2 <- crit_2_of_2(info_frac_1_2 = fitWeightedLogRankInterim$v_u / fitWeightedLogRankInterim$v_u,
                           crit_1 = c_1,
                           alpha_spend_f = gDesign$alpha_spend_f,
                           alpha_one_sided = gDesign$alpha_one_sided)
        nDecision <- ifelse(  fitWeightedLogRank$z  <=c_2, 2, 3 ) 
