...
#At an Interim Analysis
     For log Hazard Ratio    if UL < UserParam$dMAV --> Go 
                             if LL > UserParam$dTV --> No Go
                             Otherwise, continue to the next analysis. 

#At the Final Analysis: 
    If the Upper Limit of the CI, denoted by UL, is less than UserParam$dMAV --> Go
    Specifically, if UL < UserParam$dMAV --> Go
