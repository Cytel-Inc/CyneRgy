...
#' @description
#' Randomly assigns subjects to control or treatment using uniform draws, then
#' adjusts assignments to match the target arm sizes implied by the allocation ratio.
#'
#' Steps:
