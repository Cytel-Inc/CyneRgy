...
#'             \describe{
#'                  \item{Decision}{An integer vector with one value per treatment arm generated by the fixed-sequence pairwise testing procedure. `NA` indicates an arm dropped at a previous look; 0 indicates that no boundary was crossed; 1 indicates that the lower efficacy boundary was crossed; 2 indicates that the upper efficacy boundary was crossed; and 3 indicates that the futility boundary was crossed. This example uses its dose-finding decision cascade instead of the CyneRgy decision helpers.}
