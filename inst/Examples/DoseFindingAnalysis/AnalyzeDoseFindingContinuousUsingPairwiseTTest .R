<<<<<<<< HEAD:inst/Examples/DoseFindingAnalysis/R/AnalyzeDoseFindingContinuousUsingPairwiseTTest.R
...
ApplyFixedSeqPairwiseTest <- function( vRawPValues, vDoseSequence, dAlpha ) {
  ...
  return( list( vAdjPValues = vAdjPValues,
                dAdjPValGlobal = dAdjPValGlobal,
                vDecision = (vAdjPValues < dAlpha ) ) )
>>>>>>>> origin/359-MAMS-TTE-Confirmatory_Continuous-Dose-Finding:inst/Examples/DoseFindingAnalysis/AnalyzeDoseFindingContinuousUsingPairwiseTTest .R
}