...
To try this example, create a new project in East Horizon with any configuration that supports the Enrollment Integration Point. For more details, refer to the link in the box above.</div>
