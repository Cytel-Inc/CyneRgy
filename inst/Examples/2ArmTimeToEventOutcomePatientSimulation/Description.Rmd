...
plot( vTime, vHazCtrl, type = 'l', main = "Constant Hazard for Control (Ctrl = Black, Exp = Blue)", ylim = c( 0, 0.1))
lines( vTime, vHazExp, lty =2, col =4, lwd=2)
#plot( vTime, vHazExp, type = 'l', main = "Hazard for Exp (Increasing Hazard)")
plot( vTime, vHazExp/vHazCtrl, type = 'l', main = "Hazard Ratio (Constant Hazards)")
...
plot( vTime, vHazCtrl, type = 'l', main = "Increasing Hazard for Control (Ctrl = Black, Exp = Blue)", ylim = c( 0, 5))
lines( vTime, vHazExp, lty =2, col =4, lwd=2)
#plot( vTime, vHazExp, type = 'l', main = "Hazard for Exp (Increasing Hazard)")
plot( vTime, vHazExp/vHazCtrl, type = 'l', main = "Hazard Ratio (Increasing Hazards)")
...
plot( vTime, vHazCtrl, type = 'l', main = "Decreasing Hazard for Control (Ctrl = Black, Exp = Blue)", ylim = c( 0, 1))
lines( vTime, vHazExp, lty =2, col =4, lwd=2)
plot( vTime, vHazExp/vHazCtrl, type = 'l', main = "Hazard Ratio (Decreasing Hazards)")
```
