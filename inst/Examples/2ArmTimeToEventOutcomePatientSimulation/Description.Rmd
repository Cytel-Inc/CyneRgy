...
The following examples demonstrate how to add new patient outcome simulation (*response*) capabilities into East Horizon or East using an R function in the context of a two-arm trial with a time-to-event patient outcome. For all examples, we assume the trial design consists of standard of care and an experimental treatment and the trial design assumes patient outcomes are normally distributed.
