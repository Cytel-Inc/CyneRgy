...
plot( vTime, vHazCtrl, type = 'l', xlab = "Time", ylab = "Hazard", main = "Constant Hazards (Ctrl = Black, Exp = Blue)", ylim = c( 0, 0.1))
lines( vTime, vHazExp, lty =2, col =4, lwd=2)
#plot( vTime, vHazExp, type = 'l', main = "Hazard for Exp (Increasing Hazard)")
plot( vTime, vHazExp/vHazCtrl, type = 'l', xlab = "Time", ylab = "Hazard Ratio", main = "Hazard Ratio with Constant Hazards")
...
plot( vTime, vHazCtrl, type = 'l', xlab = "Time", ylab = "Hazard", main = "Increasing Hazards (Ctrl = Black, Exp = Blue)", ylim = c( 0, 5))
lines( vTime, vHazExp, lty =2, col =4, lwd=2)
#plot( vTime, vHazExp, type = 'l', main = "Hazard for Exp (Increasing Hazard)")
plot( vTime, vHazExp/vHazCtrl, type = 'l', xlab = "Time", ylab = "Hazard Ratio", main = "Hazard Ratio with Increasing Hazards")
...
plot( vTime, vHazCtrl, type = 'l', xlab = "Time", ylab = "Hazard", main = "Decreasing Hazards (Ctrl = Black, Exp = Blue)", ylim = c( 0, 1))
lines( vTime, vHazExp, lty =2, col =4, lwd=2)
plot( vTime, vHazExp/vHazCtrl, type = 'l', xlab = "Time", ylab = "Hazard Ratio", main = "Hazard Ratio with Decreasing Hazards")
