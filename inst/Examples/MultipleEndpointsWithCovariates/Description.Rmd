...
`RunExample()` opens `MultipleEndpointsWithCovariates.Rproj` in RStudio. In VS Code it opens the example folder, `Description.Rmd`, and every R script
...
This opens `Description.Rmd` and all R scripts in the active supported IDE.
