...
**RStudio Project File**: [MultipleEndpointsWithCovariates.Rproj](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/MultipleEndpointsWithCovariates/MultipleEndpointsWithCovariates.Rproj)
...
1. [SimulateMultipleOutcomes.R](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/SimulateMultipleOutcomes.R)
...
1. [SimulateMultipleOutcomesCovariates.R](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/SimulateMultipleOutcomesCovariates.R)
...
1. [SimulateMultipleOutcomesCovariatesStratRandomization.R](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/SimulateMultipleOutcomesCovariatesStratRandomization.R)
...
1. [AnalyzeMultipleOutcomes.R](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/AnalyzeMultipleOutcomes.R)
...
1. [AnalyzeMultipleOutcomesCovariates.R](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/AnalyzeMultipleOutcomesCovariate.R) - This files provides and example R function to perform statistical analysis on simulated patient-level data with three continuous endpoints and binary covariates. For each endpoint, an ANCOVA model is fitted to assess the treatment effect while adjusting for covariates.

1. [AnalyzeMultipleOutcomesCovariatesStratRandomization.R](https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/AnalyzeMultipleOutcomesCovariatesStratRandomization.R)
...
<div class="alert alert-primary" role="alert">
    <p style="margin-bottom:0"> 
        ...
        <a href="https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/SimulateMultipleOutcomes.R"         class="alert-link">SimulateMultipleOutcomes.R</a>
        and 
        <a href="https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/AnalyzeMultipleOutcomes.R" class="alert-link">SimulateMultipleOutcomes.R</a>.  
    </p>
</div>
...
flowchart <- data.frame(
    ...
    label = c("Load means of outcomes for control \n and  experimental arm: \n MeanOutcome1Ctrl, MeanOutcome2Ctrl, \n MeanOutcome3Ctrl, MeanOutcome1Trt, \n MeanOutcome2Trt, MeanOutcome3Trt", 
              "Loop through patients", 
              "Simulate each outcome using normal \n distribution", 
...
<div class="alert alert-primary" role="alert">
    <p style="margin-bottom:0"> 
        ...
        <a href="https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/SimulateMultipleOutcomesCovariates.R"         class="alert-link">SimulateMultipleOutcomes.R</a>
        and 
        <a href="https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/AnalyzeMultipleOutcomesCovariates.R" class="alert-link">SimulateMultipleOutcomes.R</a>.  
    </p>
</div>
...
<div class="alert alert-primary" role="alert">
    <p style="margin-bottom:0"> 
        This example is related to these R files: 
        <a href="https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/SimulateMultipleOutcomesCovariatesStratRandomization.R"         class="alert-link">SimulateMultipleOutcomes.R</a>
        and 
        <a href="https://github.com/Cytel-Inc/CyneRgy/tree/311-create-page-on-website-for-multiple-endpoint-example-with-covariates/inst/Examples/R/AnalyzeMultipleOutcomesCovariatesStratRandomization.R" class="alert-link">SimulateMultipleOutcomes.R</a>.  
    </p>
</div>
