...
4. [GeneratePatientFromCSVSpecific.R]() - This file is able to read in and use simulated patient data from CSV files with a specific formatting style to allow for faster run times.

5. [GeneratePatientFromCSVGeneral.R]() - This file is able to work in the same way as the specific code, but it has a more general formatting style that leads to slower run times.
...
Formatting the CSV File Using:

**GeneratePatientFromCSVGeneral.R**:
The column names for the each row have several options listed below that are accepted all of which are not case sensitive.
Visit Columns: "Visit X", "Visit.X", "VisitX"
Treatment Column: "Treatment"
Treatment IDs: "1", "t", "trt", "treatment", "active"
Control IDs: "0", "c", "ctl", "control", "placebo", "cntl"
N/A Values: "", "NA", "NaN", "na", "null", "N/A"

**GeneratePatientFromCSVSpecific.R**:
Visit Columns: "Visit X"
Treatment Column: "Treatment"
Treatment IDs: "1"
Control IDs: "0"
N/A values: "", "NA", "NaN", "na", "null", "N/A"

**Uploading and using in East Horizon**:
1. In East Horizon's Response card select "User Specified - R", as your distribution. 
2. Navigate to the "Inputs" folder.
3. Upload the code you want to use to read in CSV files.
4. Upload the CSV file.
5. Select the desired R code and set the variable name "InputFileName" to the name of the CSV file with the ".CSV" file extension included.
6. Setup the rest of the design card as desired.
