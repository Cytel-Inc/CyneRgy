...
The first step is to create an R function for simulating patient outcomes.  The function is found in ("simulatePatientOutcomeCHU9.R")[/RCode/SimulatePatientOutcomes], which presumably contains a function for simulating patient outcomes based on provided parameters.
