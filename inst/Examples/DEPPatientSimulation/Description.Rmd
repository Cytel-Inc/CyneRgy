...
`RunExample()` opens `DEPPatientSimulation.Rproj` in RStudio. In VS Code it opens the example folder, `Description.Rmd`, and every R script
...
<li>**Endpoint type:** *Time-to-Event - Time-to-Event* for Example 1, *Time-to-Event - Binary* for Example 2</li>
<li>**Task:** Explore</li>
