...
#'
#' @description
#' In this example, correlated survival and binary responses are generated using a Gaussian copula.
#' The survival endpoint uses single-piece hazard-rate inputs.
#' The simulation follows a three-step procedure.
