...
<div class="alert alert-primary" role="alert">
  <p style="margin-bottom:0">These examples are related to the <a href="IntegrationPointResponseContinuous.html" class="alert-link"><strong>Integration Point: Response - Continuous Outcome</strong></a>. Click on the link for more information about this integration point.</p>
</div>
