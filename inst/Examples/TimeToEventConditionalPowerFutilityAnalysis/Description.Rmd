...
- $n$ is the number of completers at the time of analysis.
- $r = \frac{\text{AllocInfo}}{1+\text{AllocInfo}}$ where $\text{AllocInfo}$ is the ratio of the treatment arm's sample size to the control arm's sample size.
...
- $n_1$ is the number of completers at the first look (interim analysis).
...
|Option 3 (with R, sim on Option 1)|8|993|1001|
|Option 3 (with R, sim on Option 2)|4|800|804|
