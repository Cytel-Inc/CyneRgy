...
`RunExample()` opens `TimeToEventConditionalPowerFutilityAnalysis.Rproj` in RStudio. In VS Code it opens the example folder, `Description.Rmd`, and every R script
