...
<li>**Task:** Design</li>
<li>**Test:** Logrank Test Given Accrual Duration and Study Duration (Parallel Design)</li>
...
<div class="alert alert-primary" role="alert">
  <p style="margin-bottom:0"> This example is related to this R file: <a href="https://github.com/Cytel-Inc/CyneRgy/tree/main/inst/Examples/TimeToEventConditionalPowerFutilityAnalysis/R/AnalyzeTTEWithConditionalPowerFutility.R" class="alert-link">AnalyzeTTEWithConditionalPowerFutility.R</a></p>
</div>
