...
-  **Sensitivity Analysis**: The reason for including the difference of means cards and the standard deviation cards was to illustrate how sensitive the power in this study is if the researchers' initial assumptions were off. Increasing the standard deviation to 20 or decreasing the difference of means to 4 led to the power becoming underpowered. This means we would have to increase the sample size to detect if there is a significant difference. As for the standard deviation 10 and the difference of means of 8 cards, the power dramatically increased to the mid-high 90's range. This would allow for the sample size of the study to be shrunk down and still maintain a 90% power.
