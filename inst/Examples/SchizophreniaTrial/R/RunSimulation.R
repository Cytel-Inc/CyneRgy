######################################################################################################################## .
#' @name RunSimulation
#' @title Run the Schizophrenia Trial Example
#' @description
#' Sources the response, analysis, and plotting scripts; runs single and repeated
#' schizophrenia-trial simulations; creates analysis summaries; and builds plots.
#' @author Jacob Wathen
#' @return The final mean GLS treatment-effect estimate. Running the script also
#'   creates simulation, analysis, timing, and plot objects and prints summary values.
######################################################################################################################## .
