...
![**Figure 1**: An example plot of the trial data with a 95% CI](SchizophreniaTrialFiles/TrialPlot.png){width=90%}

<br>

![**Figure 2**: An example plot of individual patient trajectories](SchizophreniaTrialFiles/PatientPlot.png){width=90%}
...
![**Project Setup**](SchizophreniaTrialFiles/ProjectSetup.png){width=90%}

Important: Make sure to toggle **Initialize R Simulations** to the ON position. You must also include an initialization R file as part of your project setup to ensure proper simulation execution.
...
![**MMRM Fixed Sample**](SchizophreniaTrialFiles/MMRMFixed.png){width=90%}
...
![**MMRM Group Sequential**](SchizophreniaTrialFiles/MMRMGS.png){width=90%}
...
![**Response Card using data from the publication**](SchizophreniaTrialFiles/PublicationResponse.png){width=90%}

<br>

![**Null Case Card**](SchizophreniaTrialFiles/NullResponse.png){width=90%}

<br>

![**Card with mean difference 4**](SchizophreniaTrialFiles/MeanDiff4.png){width=90%}

<br>

![**Card with mean difference 8**](SchizophreniaTrialFiles/Diff8Response.png){width=90%}

<br>

![**Card with SD 10**](SchizophreniaTrialFiles/StdDev10.png){width=90%}

<br>

![**Card with SD 20**](SchizophreniaTrialFiles/StdDev20.png){width=90%}
...
![**Dropout Information**](SchizophreniaTrialFiles/DropoutRate.png){width=90%}
...
![**Enrollment Card**](SchizophreniaTrialFiles/Enrollment.png){width=90%}
...
![**Simulation Setup**](SchizophreniaTrialFiles/SimulationSetup.png){width=90%}
...
![**Figure 3**: Simulation for Publication Results](SchizophreniaTrialFiles/PublicationResults.png){width=100%}
...
![**Figure 4**: Difference of Means Results](SchizophreniaTrialFiles/MeanDiff4_8Results.png)

<br>

![**Figure 5**: Standard Deviation Results](SchizophreniaTrialFiles/SD10_20Results.png)

<br>

- **Null behavior (MMRM)**: Type I error was observed between 2.1 and 3.6%, close to nominal 2.5%.

![**Figure 6**: Null Case Results](SchizophreniaTrialFiles/NullResult.png)
...
![](SchizophreniaTrialFiles/SelectDesign.png)
