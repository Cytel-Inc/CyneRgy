...
`RunExample()` opens `SchizophreniaTrial.Rproj` in RStudio. In VS Code it opens the example folder, `Description.Rmd`, and every R script
under `R/`. The R scripts do not require an RStudio project.

<div class="alert alert-primary" role="alert">
<p style="margin-bottom:0">This example is related to both the <a href="IntegrationPointResponseRepeatedMeasures.html" class="alert-link">**Integration Point: Response - Continuous Outcome with Repeated Measures**</a> and the <a href="IntegrationPointAnalysisRepeatedMeasures.html" class="alert-link">**Integration Point: Analysis - Continuous Outcome with Repeated Measures**</a>. Click the links for setup instructions, variable details, and additional information about the integration points.</p>
</div>
...
<li>**Better Response:** Smaller Value</li>
<li>**Task:** Explore</li>
</ul></div>
...
Running this code opens `Description.Rmd` and all R scripts in the active supported IDE.
...
In the MMRM fixed-sample card, the sample size should be 266. The group sequential MMRM card should have the input "200:360:20." This will create samples ranging from 200-360 patients counting up in steps of 20. Both cards use a Type I error of 0.025 and an allocation ration of 1. For the Test type, select **User Specified-R**, then upload the file 
