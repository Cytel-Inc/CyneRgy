...
`RunExample()` opens `ConsecutiveStudiesContinuous.Rproj` in RStudio. In VS Code it opens the example folder, `Description.Rmd`, and every R script
...
<div class="alert alert-secondary" role="alert">
  <p style="margin-bottom:0">The following example does not show how to load Phase 2 data into a Phase 3 trial. Please see the <a href="ConsecutiveStudiesBinary.html" class="alert-link">**Consecutive Studies, Binary Outcome**</a> example for more information and step-by-step instructions.</p>
</div>
