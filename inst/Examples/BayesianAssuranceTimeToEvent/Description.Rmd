...
In the [R directory of this example](https://github.com/Cytel-Inc/CyneRgy/tree/main/inst/Examples/BayesianAssuranceTimeToEvent/R) you will find the R files used in the examples:
