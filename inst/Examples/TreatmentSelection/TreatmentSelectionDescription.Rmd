...
<div class="alert alert-primary" role="alert">
  <p style="margin-bottom:0">This example is related to the <strong>Integration Point: Treatment Selection</strong>.
  <a href="IntegrationPointTreatmentSelection.html" class="alert-link">Click here for more information about this integration point.</a></p>
</div>
