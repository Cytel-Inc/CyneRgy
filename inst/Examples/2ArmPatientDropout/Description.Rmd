...
author: "Shubham Lahoti, J. Kyle Wathen, Gabriel Potvin"
...
|**Parameter in East Horizon**|**Section of East Horizon**|**Variable in the R script**|
|---|---|---|
...
flowchart <- data.frame(
  ...
  label = c("Load dropout probabilities (cont./exp.)", 
