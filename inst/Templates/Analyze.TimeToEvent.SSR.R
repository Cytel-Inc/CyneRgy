...
#'          \item{MaxEventsMult}{Multiplier applied to the maximum number of sample sizes for SSR} 
...
#'                    \item{MaxEventsMult}{Multiplier applied to the maximum number of events
#'                          for SSR}
#'                    \item{MaxSSMult}{Multiplier applied to the maximum number of sample sizes
#'                          for SSR}            
#'                }}
#'      }
...
#'                      }
# 
#'Function Template for performing SSR for TTE Endpoints
{{FUNCTION_NAME}} <- function(SimData, DesignParam, LookInfo, AdaptInfo)
{
  ...
  return(list(ReEstEvents = as.integer(retval1), Decision = as.integer(retval2), ErrorCode = as.integer(Error)))
}