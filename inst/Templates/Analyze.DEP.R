...
#'                  User should access the variables using names, for example UserParam$`endpoint name`Var1 and not order -- replace `endpoint name` with the name of the analysis endpoint.
