...
#' @name {{FUNCTION_NAME}}
#' @title Analyze Multi-Arm Continuous Outcomes
#' @description Analyze simulated continuous outcomes for a multiple-arm confirmatory design at the current look.
