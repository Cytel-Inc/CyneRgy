...
#' @name {{FUNCTION_NAME}}
#' @title Analyze Continuous Outcomes
#' @description Template for analyzing simulated continuous outcomes at an interim or final analysis.
...
{{FUNCTION_NAME}} <- function( SimData, DesignParam, LookInfo = NULL, UserParam = NULL )
{
    ...
    # Step 1 - If LookInfo is NULL, then this is a fixed design and all rows in SimData are analyzed ####
