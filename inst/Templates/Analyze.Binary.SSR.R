...
#' @name {{FUNCTION_NAME}}
#' @title Analyze Binary Outcomes with Sample Size Re-Estimation
#' @description Analyze simulated binary outcomes and return the re-estimated completer count and decision for the current look.
...
#'                                     }
#'                      }
#' Template for sample size re-estimation with a binary endpoint.
######################################################################################################################## .
