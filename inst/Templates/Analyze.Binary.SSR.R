...
#'
#'      }
#' @param AdaptInfo A list containing sample-size re-estimation (SSR) parameters.
#'      The items are as follows:
#'      \describe{
#'          \item{SSRFuncScale}{Sample size re-estimation rule type:
#'                0 = continuous rule; 1 = step function rule}
#'          \item{PromZoneMin}{Lower bound of the promising zone (used for continuous SSR)}
#'          \item{PromZoneMax}{Upper bound of the promising zone}
#'          \item{MaxSSMult}{Multiplier applied to the maximum number of sample sizes for SSR}
#'          \item{MaxSSMultInp}{List defining step-wise sample size inflation parameters,
#'                containing the following elements:
#'                \describe{
#'                    \item{From}{Lower boundary of the conditional power interval}
#'                    \item{To}{Upper boundary of the conditional power interval}
#'                    \item{MaxSSMult}{Multiplier applied to the maximum number of samplesizes
#'                          for SSR}
#'                }}
#'      }
...
{{FUNCTION_NAME}} <- function( SimData, DesignParam, LookInfo, AdaptInfo )
{
    nError  <- 0
    retval1 <- 0
    retval2 <- 0
