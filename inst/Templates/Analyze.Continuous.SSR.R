...
#'                                     }
#'                      }
# Function Template for performing SSR for Normal and Binary Endpoints
{{FUNCTION_NAME}} <- function(SimData, DesignParam, LookInfo, AdaptInfo)
{
  ...
  return(list(ReEstCompleters = as.integer(retval1), Decision = as.integer(retval2), ErrorCode = as.integer(Error)))
}
