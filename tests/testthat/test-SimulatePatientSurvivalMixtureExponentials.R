...
#   Description: Test file for SimulatePatientSurvivalMixtureExponentials
#   Change History:
#   Last Modified Date: 6/20/2024
#################################################################################################### .


context( "SimulatePatientSurvivalMixtureExponentials")

test_that("Test- SimulatePatientSurvivalMixtureExponentials", {
    ...
    lRet1 <- tryCatch({
        SimulatePatientSurvivalMixtureExponentials(NumSub, NumArm, TreatmentID, SurvMethod, NumPrd, PrdTime, SurvParam, UserParam = NULL)
    }, error = function(e) {
        NULL
    })
    ...
    lRet2 <- tryCatch({
        SimulatePatientSurvivalMixtureExponentials(NumSub, NumArm, TreatmentID, SurvMethod, NumPrd, PrdTime, SurvParam, UserParam)
    }, error = function(e) {
        NULL
    })
    ...
    lRet3 <- tryCatch({
        SimulatePatientSurvivalMixtureExponentials(NumSub, NumArm, TreatmentID, SurvMethod, NumPrd, PrdTime, SurvParam)
    }, error = function(e) {
        NULL
    })
