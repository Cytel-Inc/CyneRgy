...
#   Description: Test file for SimulatePatientOutcomePercentAtZeroBetaDist
#   Change History:
#   Last Modified Date: 6/20/2024
#################################################################################################### .


context( "SimulatePatientOutcomePercentAtZeroBetaDist")

test_that("Test- SimulatePatientOutcomePercentAtZeroBetaDist", {
    ...
    lRet1 <- tryCatch({
        SimulatePatientOutcomePercentAtZeroBetaDist(NumSub, TreatmentID, Mean, StdDev, UserParam = NULL)
    }, error = function(e) {
        NULL
    })
    ...
    UserParam     <-list(dCtrlBetaParam1 = 0.1, dCtrlBetaParam2 = 0.1, dExpBetaParam1 = 0.1, dExpBetaParam2 = 0.1 )
    
    lRet2 <- tryCatch({
        SimulatePatientOutcomePercentAtZeroBetaDist(NumSub, TreatmentID, Mean, StdDev, UserParam )
    }, error = function(e) {
        NULL
    })
    ...
    lRet3 <- tryCatch({
        SimulatePatientOutcomePercentAtZeroBetaDist(NumSub, TreatmentID, Mean, StdDev)
    }, error = function(e) {
        NULL
    })
