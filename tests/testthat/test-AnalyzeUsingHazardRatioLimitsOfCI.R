...
context( "AnalyzeUsingHazardRatioLimitsOfCI")

test_that("Test- AnalyzeUsingHazardRatioLimitsOfCI", {
    ...
    lRet1 <- tryCatch({
        AnalyzeUsingHazardRatioLimitsOfCI( SimData, DesignParam, LookInfo = NULL, UserParam = NULL )
    }, error = function(e) {
        NULL
    })
    ...
    lRet2 <- tryCatch({
        AnalyzeUsingHazardRatioLimitsOfCI( SimData, DesignParam, LookInfo = LookInfo, UserParam = NULL )
    }, error = function(e) {
        NULL
    })
    ...
    lRet3 <- tryCatch({
        AnalyzeUsingHazardRatioLimitsOfCI( SimData, DesignParam )
    }, error = function(e) {
        NULL
    })
