...
3. [**Multiple Arm, Patient Simulation**](MultiArmPatientSimulation.html)
    - [SimulatePatientOutcomeMultiArmPercentAtZero.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/MultiArmOPatientSimulation/R/SimulatePatientOutcomeMultiArmPercentAtZero.R)
