...
|----------------|--------------|---------------------------------------------------------------------------------|
|**NumSub**|Integer|Number of subjects.|
...
1. [**2-Arm, Normal Outcome - Patient Simulation**](2ArmNormalOutcomePatientSimulationDescription.html)
    - [SimulatePatientOutcomePercentAtZero.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/2ArmNormalOutcomePatientSimulation/RCode/SimulatePatientOutcomePercentAtZero.R)
    - [SimulatePatientOutcomePercentAtZeroBetaDist.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/2ArmNormalOutcomePatientSimulation/RCode/SimulatePatientOutcomePercentAtZeroBetaDist.R)
1. [**Childhood Anxiety Trial**](ChildhoodAnxiety.html)
    - [SimulatePatientOutcomeCHU9.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/ChildhoodAnxiety/RCode/SimulatePatientOutcomeCHU9.R)
    - [SimulatePatientOutcomeCHU9V2.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/ChildhoodAnxiety/RCode/SimulatePatientOutcomeCHU9V2.R)
