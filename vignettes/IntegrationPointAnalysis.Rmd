...
Note: This integration point is compatible with Sample Size Re-Estimation (distinct templates and examples were created for SSR) and Stratification/Subpopulations (distinct templates and examples were created for Stratification and Stratification with Subpopulations).
