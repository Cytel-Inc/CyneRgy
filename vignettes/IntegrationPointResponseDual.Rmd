...
1. [**Dual Endpoints - Patient Simulation**](DEPOutcomePatientSimulation.html)
    - [SimulatePatientOutcomeSurvSurvSingleHazardPiece.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/DEPOutcomePatientSimulation/SimulatePatientOutcomeSurvSurvSingleHazardPiece.R)
