...
1. [**Continuous (Normal) Outcome**](IntegrationPointResponseContinuous.html)
1. [**Continuous (Normal) Outcome with Repeated Measures**](IntegrationPointResponseRepeatedMeasures.html)
1. [**Binary Outcome**](IntegrationPointResponseBinary.html)
1. [**Time-to-Event (Survival) Outcome**](IntegrationPointResponseTimeToEvent.html)
