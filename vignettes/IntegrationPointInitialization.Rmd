...
|----------------|----------|---------------------------------------------------------------------------------|
|**Seed**|Integer|Randomization seed set in East Horizon in Simulation Setup.|
...
1. Used to load libraries in [**2-Arm, Normal Outcome, Repeated Measures - Patient Simulation**](2ArmNormalRepeatedMeasuresResponseGeneration.html).
