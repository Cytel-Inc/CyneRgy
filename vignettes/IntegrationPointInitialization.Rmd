...
<details>
<summary>This integration point is available in East for the following tests:</summary>
- Design, Continuous Endpoint, Two-Sample Test, Parallel Design, Difference of Means (MN-2S-DI)
- Design, Discrete (Binary) Endpoint, Two-Sample Test, Parallel Design, Difference of Proportions (PN-2S-DI)
- Design, Discrete (Binary) Endpoint, Two-Sample Test, Parallel Design, Ratio of Proportions (PN-2S-RA)
- Design, Discrete (Binary) Endpoint, Two-Sample Test, Parallel Design, Odds Ratio of Proportions PN-2S-OR
- Design, Survival Endpoint, Two-Sample Test, Parallel Design, Logrank Given Accrual Duration and Accrual Rates (SU-2S-LRAR)
- Design, Survival Endpoint, Two-Sample Test, Parallel Design, Logrank Given Accrual Duration and Study Duration (SU-2S-LRSD)
- Design, Discrete (Binary) Endpoint, Many-Sample Test, Single Arm Design, Chi-Square for Specified Proportions in C Categories (PN-ns-CH1C)
- Design, Discrete (Binary) Endpoint, Many-Sample Test, Parallel Design, Two Group Chi-Square for Specified Proportions in C Categories (PN-ns-CH2C)
- Design, Continuous Endpoint, Many-Sample Test, Pairwise Comparisons to Control - Difference of Means, Multiple Looks - Combining P-Values (MN-MAMS-PC)
- Design, Discrete (Binary) Endpoint, Many-Sample Test, Multiple Pairwise Comparisons to Control - Difference of Proportions, Multiple Looks - Combining P-Values (PN-MAMS-PC)
- Design, Survival (Time-to-Event) Endpoint, Many-Sample Test, Pairwise Comparisons to Control - Logrank Test, Multiple Looks - Combining P-Values (SU-MAMS-PC)
</details>
...
You can set up an initialization function in East by navigating to the **User Defined R Function** tab of a **Simulation Input**, after including the option. For some tests, the option will be available in the **Treatment Selection** tab.

<details>
<summary>Follow these steps:</summary>

1. Choose the appropriate test in the **Design** tab.
1. If you see the **Design Input** window, navigate to the **Simulation Input** window by clicking on the **Simulate Design** button under **Library**.
1. Click on the **Include Options** button on the top right corner of the **Simulation Input** window and select **User Defined R Function**.
