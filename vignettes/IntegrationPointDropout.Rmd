...
You can set up a dropout function in East Horizon Explore under **Dropout Distribution** in a **Response Card** while creating or editing an **Input Set**. For a Time-to-Event outcome or a Continuous outome with Repeated Measures, it will be under **Distribution** in the **Dropout Rate** tab of the **Response Card**. Follow these steps:
...
![Screenshot of East Horizon (Dropout Distribution)](dropout.png)

![Screenshot of East Horizon (Tab Dropout Rate, Distribution)](dropout2.png)
