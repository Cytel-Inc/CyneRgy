...
You can set up a dropout function in East Horizon Explore under **Dropout Distribution** in a **Response Card** while creating or editing an **Input Set**. For some endpoint types and study objectives, it will be under **Distribution** in the **Dropout Rate** tab. Follow these steps:
