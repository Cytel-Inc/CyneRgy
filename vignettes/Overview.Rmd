...
<a href="IntegrationPointMultiplicityAdjustment.html" class="btn btn-primary"><i class="fas fa-calculator"></i>Multiplicity Adjustment (DEP)</a>

<a href="IntegrationPointDesign.html" class="btn btn-primary"><i class="fas fa-pencil-ruler"></i>Design (MEP)</a>
