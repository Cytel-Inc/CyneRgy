...
|-----------------|-------------|--------------------------------------------------------------------------------------------------|
| **TreatmentID**   | Vector of Integer  | Vector of length `NumSub`, containing the allocation indices for all subjects (0 for control arm, 1 for first experimental arm, etc.).
