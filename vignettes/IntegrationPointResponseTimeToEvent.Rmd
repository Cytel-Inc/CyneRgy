...
|**ArrivalTime**|Vector of Numeric|Optional. Vector of length `NumSub`, indicating the arrival time for each subject.|
...
Your R script could contain a function such as this one, with a name of your choice. All input variables must be declared, even if they are not used in the script. Optional parameters such as `ArrivalTime` may be omitted. We recommend always declaring `UserParam` as a default `NULL` value in the function arguments, as this will ensure that the same function will work regardless of whether the user has specified any custom parameters in East Horizon.
...
<!-- 2. [**Multiple Arm, Patient Simulation**](MultiArmPatientSimulation.html)
    - [SimulatePatientSurvivalMultiArmWeibull.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/MultiArmOutcomePatientSimulation/R/SimulatePatientSurvivalMultiArmWeibull.R) -->
