...
|**DropMethod**|Integer|Selected method for dropout parameters from the East Horizon dropdown list:<br>– `1`: Dropout hazard rate.<br>– `2`: Probability of dropout.|
...
1. [**2-Arm, Single Endpoint - Simulate Patient Dropout**](PatientDropout.html)
    - [GenerateDropoutTimeForSurvival.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/2ArmPatientDropout/RCode/GenerateDropoutTimeForSurvival.R)
