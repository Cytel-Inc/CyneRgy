...
2. [**Multiple Arm, Patient Simulation**](MultiArmPatientSimulation.html)
    ...
    - [SimulatePatientOutcomeMultiArmExpGivenMST.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/MultiArmPatientSimulation/R/SimulatePatientOutcomeMultiArmExpGivenMST.R)
