...
```
GenerateResponse <- function( NumSub, NumArm, TreatmentID, SurvMethod, NumPrd, PrdTime, SurvParam, UserParam = NULL )
{
...
2. [**Multiple Arm, Patient Simulation**](MultiArmOutcomePatientSimulation.html)
    - [SimulatePatientSurvivalWeibull.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/MultiArmOutcomePatientSimulation/TimeToEvent/R/SimulatePatientSurvivalWeibull.R)
