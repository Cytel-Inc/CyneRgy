...
Detailed templates with step-by-step explanations are available here: [Analyze.Binary.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Binary.R) for 2-Arm and [Analyze.Binary.MAMS.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Binary.MAMS.R) for Multiple Arm.
...
2. [**Multiple Arm, Analysis**](MultiArmOutcomeAnalysis.html)
    - [AnalyzeUsingPropTestBonferroni.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/MultiArmOutcomeAnalysis/Binary/R/AnalyzeUsingPropTestBonferroni.R)
