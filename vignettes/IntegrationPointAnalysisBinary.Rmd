...
Detailed templates with step-by-step explanations are available here: [Analyze.Binary.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Binary.R) for 2-Arm, [Analyze.Binary.SSR.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Binary.SSR.R) for 2-Arm with SSR, and [Analyze.Binary.MAMS.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Binary.MAMS.R) for Multiple Arm.
...
1. [**2-Arm, Binary Outcome - Analysis**](2ArmBinaryOutcomeAnalysis.html)
