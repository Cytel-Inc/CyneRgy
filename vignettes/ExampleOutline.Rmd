...
1. **[Probability of Success for Binary Endpoint](ProbabilitySuccessBinaryEndpoint.html)**: Simple example to demonstrate how to compute the probability of success of a trial.
