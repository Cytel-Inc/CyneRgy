...
1. **[Schizophrenia Trial (MMRM Analysis)](SchizophreniaTrial.html)**: This example demonstrates how to simulate and analyze data using a Mixed Model for Repeated Measures (MMRM) approach in the context of a schizophrenia trial.
