...
1. **[PK/PD Modeling](PKPDResponseGeneration.html)**: This example demonstrates the capabilities of PK/PD modeling in East Horizon using R integration by simulating plasma drug concentrations using a one-compartment model with first-order absorption and elimination, then transforming concentration to effect via an Emax model to generate continuous outcomes.
