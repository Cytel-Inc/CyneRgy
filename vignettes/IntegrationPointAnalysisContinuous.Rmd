...
Detailed templates with step-by-step explanations are available here: [Analyze.Continuous.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Continuous.R) for 2-Arm and [Analyze.Continuous.MAMS.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Templates/Analyze.Continuous.MAMS.R) for Multiple Arm.
...
1. [**2-Arm, Continuous Outcome - Analysis**](2ArmNormalOutcomeAnalysisDescription.html)
...
2. [**Multiple Arm, Analysis**](MultiArmOutcomeAnalysis.html)
    - [AnalyzeUsingTTestBonferroni.R](https://github.com/Cytel-Inc/CyneRgy/blob/main/inst/Examples/MultiArmOutcomeAnalysis/Normal/R/AnalyzeUsingTTestBonferroni.R)
